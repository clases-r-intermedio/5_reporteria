...
ene <- map_df(ene,~mutate(.x,across(c(ocupados,desocupados,pet,fdt), list(exp = ~ ponderar(.,fact_cal)))) %>% 
...
* sería buena idea aplicar las tablas de la lista con `r dplyr::bind_rows()`
